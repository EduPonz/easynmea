...
*EasyNMEA* is an open source, free-to-use cross-platform `C++` library to retrieve **Global Navigation Satellite
...
*EasyNMEA* provides a lightweight and easy-to-use API with which applications can wait until
...
The source code is hosted on `GitHub <https://github.com/EduPonz/easynmea>`_, check it out!
