...
*OpenNMEA* provides the |OpenNmea-api| class, which uses
...
The following snippet shows how to use |OpenNmea::open-api|, |OpenNmea::wait_for_data-api|,
|OpenNmea::take_next-api|, and |OpenNmea::close-api| APIs to wait until |GPGGAData-api| data is received,
